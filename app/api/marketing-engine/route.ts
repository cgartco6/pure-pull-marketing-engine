...
export async function POST(req: Request) {
  try {
    ...
    You MUST respond with a single, valid JSON object matching this structural scheme exactly with no extra prose text before or after the JSON:
    {
    ...
    // Using Google Gemma 2 9B Free tier endpoint
    ...
    // Quick sanitization fallback in case the model wraps the JSON in markdown code blocks
